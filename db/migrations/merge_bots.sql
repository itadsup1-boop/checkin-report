...
ALTER TABLE group_settings ADD COLUMN IF NOT EXISTS shift_1_time VARCHAR(10) DEFAULT '08:30-18:00';
ALTER TABLE group_settings ADD COLUMN IF NOT EXISTS shift_2_time VARCHAR(10) DEFAULT '08:30-18:00';
