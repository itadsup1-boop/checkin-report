...
test('Xuất Excel nằm tại Điểm danh và lọc theo ngày, nhóm', () => {
  ...
  assert.match(exportRouteSource, /const requestedGroupId = req\.query\.group_id/);
  assert.match(exportUseCaseSource, /exportGroupIds: requestedGroupId \? \[requestedGroupId\] : allowedGroupIds/);
});
